...
def safe_exp(val):
    ...
    if val > largest_safe_exponent:
        print("[WARN]: Exponential term was capped to avoid overflow. This may cause divergence.")
        return math.exp(largest_safe_exponent)
    elif val < smallest_safe_exponent:
        print("[WARN]: Exponential term was capped to avoid underflow. This may cause divergence.")
